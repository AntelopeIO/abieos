...
#   pragma clang diagnostic pop
   ...
   struct call_trace_v0 {
      eosio::varuint32              call_ordinal     = {};
      ...
      int64_t                       elapsed          = {};
      std::string                   console          = {};
      std::vector<eosio::varuint32> console_markers  = {};
   ...
   EOSIO_REFLECT(call_trace_v0, call_ordinal, sender_ordinal, receiver,
                 read_only, data, elapsed, console, console_markers, except,
                 error_code, error_id, return_value)

   using call_trace = std::variant<call_trace_v0>;
   ...
   EOSIO_REFLECT(action_trace_v2, action_ordinal, creator_action_ordinal, receipt,
                 ...
                 except, error_code, return_value, call_traces, console_markers)
   ...
   struct chain_config_v2 {
      ...
      uint16_t max_authority_depth                 = {};
      uint32_t max_action_return_value_size        = {};
      uint32_t max_sync_call_depth                 = {};
      uint32_t max_sync_call_data_size             = {};
   };

   EOSIO_REFLECT(chain_config_v2, max_block_net_usage, target_block_net_usage_pct, max_transaction_net_usage,
               base_per_transaction_net_usage, net_usage_leeway, context_free_discount_net_usage_num,
               context_free_discount_net_usage_den, max_block_cpu_usage, target_block_cpu_usage_pct,
               max_transaction_cpu_usage, min_transaction_cpu_usage, max_transaction_lifetime,
               deferred_trx_expiration_window, max_transaction_delay, max_inline_action_size, max_inline_action_depth,
